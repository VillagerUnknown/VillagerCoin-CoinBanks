...
public class CoinBankBlocks {
	...
	static{
		...
		DIAMOND_COIN_BANK = CoinBankBlocksFeatureLoader.registerJarCoinBankBlock( "diamond_coin_bank" );
		...
		AMETHYST_COIN_BANK = CoinBankBlocksFeatureLoader.registerJarCoinBankBlock( "amethyst_coin_bank" );
		...
		WARM_PIG_COIN_BANK = CoinBankBlocksFeatureLoader.registerPiggyBankBlock( "warm_piggy_bank" );
		
		PIGLIN_COIN_BANK = CoinBankBlocksFeatureLoader.registerPiggyBankBlock( "piglin_bank" );
		ZOMBIFIED_PIGLIN_COIN_BANK = CoinBankBlocksFeatureLoader.registerPiggyBankBlock( "zombified_piglin_bank" );
		
		WHITE_SHEEP_COIN_BANK = CoinBankBlocksFeatureLoader.registerSheepBankBlock( "white_sheep_bank" );
		ORANGE_SHEEP_COIN_BANK = CoinBankBlocksFeatureLoader.registerSheepBankBlock( "orange_sheep_bank" );
		MAGENTA_SHEEP_COIN_BANK = CoinBankBlocksFeatureLoader.registerSheepBankBlock( "magenta_sheep_bank" );
		LIGHT_BLUE_SHEEP_COIN_BANK = CoinBankBlocksFeatureLoader.registerSheepBankBlock( "light_blue_sheep_bank" );
		YELLOW_SHEEP_COIN_BANK = CoinBankBlocksFeatureLoader.registerSheepBankBlock( "yellow_sheep_bank" );
		LIME_SHEEP_COIN_BANK = CoinBankBlocksFeatureLoader.registerSheepBankBlock( "lime_sheep_bank" );
		PINK_SHEEP_COIN_BANK = CoinBankBlocksFeatureLoader.registerSheepBankBlock( "pink_sheep_bank" );
		GRAY_SHEEP_COIN_BANK = CoinBankBlocksFeatureLoader.registerSheepBankBlock( "gray_sheep_bank" );
		LIGHT_GRAY_SHEEP_COIN_BANK = CoinBankBlocksFeatureLoader.registerSheepBankBlock( "light_gray_sheep_bank" );
		CYAN_SHEEP_COIN_BANK = CoinBankBlocksFeatureLoader.registerSheepBankBlock( "cyan_sheep_bank" );
		PURPLE_SHEEP_COIN_BANK = CoinBankBlocksFeatureLoader.registerSheepBankBlock( "purple_sheep_bank" );
		BLUE_SHEEP_COIN_BANK = CoinBankBlocksFeatureLoader.registerSheepBankBlock( "blue_sheep_bank" );
		BROWN_SHEEP_COIN_BANK = CoinBankBlocksFeatureLoader.registerSheepBankBlock( "brown_sheep_bank" );
		GREEN_SHEEP_COIN_BANK = CoinBankBlocksFeatureLoader.registerSheepBankBlock( "green_sheep_bank" );
		RED_SHEEP_COIN_BANK = CoinBankBlocksFeatureLoader.registerSheepBankBlock( "red_sheep_bank" );
		BLACK_SHEEP_COIN_BANK = CoinBankBlocksFeatureLoader.registerSheepBankBlock( "black_sheep_bank" );
		
		COW_COIN_BANK = CoinBankBlocksFeatureLoader.registerCowBankBlock( "cow_bank" );
		RED_MOOSHROOM_COIN_BANK = CoinBankBlocksFeatureLoader.registerCowBankBlock( "red_mooshroom_bank" );
		BROWN_MOOSHROOM_COIN_BANK = CoinBankBlocksFeatureLoader.registerCowBankBlock( "brown_mooshroom_bank" );
		
		BEE_COIN_BANK = CoinBankBlocksFeatureLoader.registerBeeBankBlock( "bee_bank" );
